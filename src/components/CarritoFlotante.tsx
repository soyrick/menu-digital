...
export default function CarritoFlotante() {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 bg-orange-500 hover:bg-orange-600 text-white px-6 py-4 rounded-full shadow-xl z-30 flex items-center gap-3 transition-all duration-200 hover:scale-105 active:scale-95 animate-bounce-subtle"
    >
